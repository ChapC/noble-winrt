...
private:
    ...
    void OnCharacteristicsDiscovered(IAsyncOperation<GattCharacteristicsResult> asyncOp, AsyncStatus status, std::string uuid, winrt::guid serviceUuid, std::vector<winrt::guid> characteristicUUIDs);
